...
REGIONS = [
    "INDIA", "NORTH_AMERICA", "EUROPE", "SOUTHEAST_ASIA",
    "MIDDLE_EAST", "EAST_ASIA", "LATIN_AMERICA",
]

SALES_BY_REGION = {
    "INDIA": [
        820000, 780000, 910000, 870000, 950000, 1020000,
        980000, 1050000, 1100000, 1080000, 1150000, 1200000,
    ],
    "NORTH_AMERICA": [
        640000, 610000, 720000, 690000, 750000, 810000,
        780000, 840000, 880000, 860000, 920000, 960000,
    ],
    "EUROPE": [
        520000, 490000, 580000, 550000, 610000, 660000,
        630000, 680000, 720000, 700000, 750000, 790000,
    ],
    "SOUTHEAST_ASIA": [
        340000, 310000, 380000, 360000, 400000, 420000,
        390000, 440000, 460000, 450000, 480000, 500000,
    ],
    "MIDDLE_EAST": [
        210000, 190000, 240000, 220000, 260000, 280000,
        250000, 290000, 310000, 300000, 330000, 350000,
    ],
    "EAST_ASIA": [
        280000, 260000, 310000, 290000, 330000, 360000,
        340000, 370000, 390000, 380000, 410000, 440000,
    ],
    "LATIN_AMERICA": [
        150000, 140000, 170000, 160000, 180000, 200000,
        190000, 210000, 230000, 220000, 240000, 260000,
    ],
}
